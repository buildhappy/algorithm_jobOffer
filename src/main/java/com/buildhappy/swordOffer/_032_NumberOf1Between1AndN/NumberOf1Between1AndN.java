package com.buildhappy.swordOffer._032_NumberOf1Between1AndN;
...
public class NumberOf1Between1AndN {
	...
	public static int numberOf1_2(String num){
		...
		int numFirstDigit;
		if(firstNum == 1){
			numFirstDigit = Integer.parseInt(num.substring(1 , num.length())) + 1;
		}else
		...
		int numRecursive = numberOf1_2(num.substring(1, num.length()));
	...
	public static void main(String[] args) {
		...
		String num = n + "";
		System.out.println(Integer.parseInt(num.substring(0 , 1)) == 1);
		System.out.println(Integer.parseInt(num.substring(1 , num.length())));
