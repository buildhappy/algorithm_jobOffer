package com.buildhappy.swordOffer._043;
...
public class ProbabilityOfDice {
	...
	public static void main(String[] args) {
		// n是骰子的个数
		int n = 2;
		printProbabilityOfDice_1(n);// solution 1,use recursion
		System.out.println("============");
		printProbabilityOfDice_2(n);// solution 2,use DP
	}
	//法一：利用递归
	public static void printProbabilityOfDice_1(int n) {
		...
		for (int i = 1; i <= MAX; i++) {// initial the first dice.
			probabilityOfDice(n, i, n, 0, times);// count the times of each
													// possible sum
		}
		for (int i = 0; i < len; i++) {
	...
	public static void probabilityOfDice(int n, int curDiceValue,
